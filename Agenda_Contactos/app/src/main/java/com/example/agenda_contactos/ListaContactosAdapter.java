...
public class ListaContactosAdapter extends RecyclerView.Adapter<ListaContactosAdapter.ContactoViewHolder> {
    ...
    public ContactoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.lista_contactos, null, false);
    ...
    public void filtrado(final String txtBuscar) {
        ...
        if (longitud == 0) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                List<Contacto> collecion = listaContactos.stream()
    ...
    public class ContactoViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView viewNombre, viewTelefono, viewDireccion, viewEmail;

        public ContactoViewHolder(@NonNull View itemView) {
            super(itemView);

            viewNombre = itemView.findViewById(R.id.textNombre2);
            viewTelefono = itemView.findViewById(R.id.textTelefono2);
            viewDireccion= itemView.findViewById(R.id.txtDireccionadd);
            viewEmail = itemView.findViewById(R.id.txtEmailadd);
